...
$mail->Username='itsupport@i3cubes.com';
$mail->Password='managemyweb@445';

$mail->isHTML(true);

$mail->SetFrom('itsupport@i3cubes.com','i3cubes Contact us form');
$mail->Sender = $email;
...
//$mail->AddAddress('lahirueranga@ngslanka.com','Lahiru Eranga');
//$mail->AddAddress('sohan@ngslanka.com','Sohan De Silva');
...
<head>
    ...
    <title>I3CUBES (pvt) Limited</title>
...
<body>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container ">
            ...
            <div class="navbar-header">
                <a class="navbar-brand " href="#home">I3CUBES (pvt) Limited</a>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav  animated fadeInDown" style="float: right;">
	...
	<div>
	<div>
            <img src="img/full_size.png" class="img-responsive hidden-xs" alt="product 1" style="width:100%; padding-top:60px;">
            <img src="img/mobile.png" class="img-responsive .visible-xs hidden-md hidden-lg hidden-sm" alt="product 1" style="width:100%; padding-top:60px;">
	</div>
	</div></section>
                ...
                <div class="col-md-6 col-1">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="abouts">
                            ...
                            <p>I3CUBES (pvt) Limited. is a software development and a managed services
...
quality in every investment you make at all times.</p>
                        ...
                        <div role="tabpanel" class="tab-pane" id="mission">
                            <h2>Our Mission</h2>
                            <p>I3C makes a significant contribution to the business world in its role<br> as a value-adding partner
to its clients. I3C continues to provide technologies that respond to customers need in increasingly sophisticated, divers and rapidly changing technological fields. We are flexible when it comes to product changes according to customer requirements and products are always designed to be future proof as much as possible using cutting edge technologies. Recognizing the people as the most important element of productivity in any organization; I3C is continuously committed to cultivate leaders of tomorrow by specializing in developing and implementing their own unique cooperate team culture.</p>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row product-1 revealOnScroll opacity-0" data-animation="fadeInUp" data-timeout="400">
                <div class="col-md-5 product-img nopadding">
                    <!--<a href="https://youtu.be/wUCrxT3iMeA" data-toggle="lightbox" data-title="UTrack">-->
                        <img src="img/Product-utrack.jpg" class="img-responsive" alt="product 1" />
                    <!--</a>-->
            ...
            <div class="row product-4 revealOnScroll opacity-0" data-animation="fadeInUp" data-timeout="400">
                <div class="col-md-7 product-info nopadding">
                    <h3>Process Management Systems</h3>
                    ...
                    <a href="http://220.247.201.100/autobavaria/" target="" class="btn btn-default btn-lg">Proceed to Site</a>
                </div>
                <div class="col-md-5 product-img nopadding">
                    <div class="slider">
...
<!--    <section class="news" id="news">
        <div class="container">
            ...
            <div class="row news-item">
                <div class="col-md-12">
                    ...
                    <h4><a a href="#">I3C expand their operations .Opened a sophisticated development Centre </a></h4>
                    <p>I3C expand their operations .Opened a sophisticated development Centre </p>
                </div>
            </div>
            <div class="row news-item">
                <div class="col-md-12">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <article>
                    <div class="article-wrapper">
                        <figure>
                        <img src="img/client-1-hover.jpg" alt="suwasariya" style="width: 200px; height: auto; padding-top: 3px"/>
                        </figure>
            ...
            <div class="col-md-3">
                ...
                <article>
                    <div class="article-wrapper">
                        <figure>
                        <img src="img/client-2-hover.jpg" alt="Auto Bavaria" style="width: 120px; height: auto; padding-top: 1rem" />
                        </figure>
                        <div class="article-body">
                            <h5>Auto Bavaria</h5>
                        </div>
            ...
            <div class="col-md-3">
                ...
                <article>
                    <div class="article-wrapper">
                        <figure>
                        <img src="img/client-3-hover.jpg" alt="Redox-Chemical Industries-Ltd." style="width: 170px; height: auto;padding-top: 1rem" />
                        </figure>
                        <div class="article-body">
                            <h5>Redox Chemical Industries. Ltd.</h5>
                        </div>
                    </div>
                </article>
                </section>
            ...
            <div class="col-md-3">
                ...
                <article>
                    <div class="article-wrapper">
                        <figure>
                        <img src="img/client-5-hover.jpg" alt="Energynet" style="width: 140px; height: auto; padding-top: 3rem" />
                        </figure>
                        <div class="article-body">
                            <h5>Energynet</h5>
                        </div>
            ...
            <div class="col-md-3">
                ...
                <article>
                    <div class="article-wrapper">
                        <figure>
                        <img src="img/client-6-hover.jpg" alt="Hayleys-Fentons" style="width: 90px; height: auto; padding-top: 1rem" />
                        </figure>
                        <div class="article-body">
                            <h5>Hayleys Fentons Ltd</h5>
                        </div>
                    </div>
                </article>
                </section>
            ...
            <div class="col-md-3">
                ...
                <article>
                    <div class="article-wrapper">
                        <figure>
                        <img src="img/client-11-hover.jpg" alt="LeoSys-Corporation-(Pvt)-Ltd" style="padding: 5rem;" />
                        </figure>
                        <div class="article-body">
                            <h5> LeoSys Corporation (Pvt) Ltd</h5>
                        </div>
                    </div>
                </article>
                </section>
            ...
            <div class="col-md-3">
                ...
                <article>
                    <div class="article-wrapper">
                        <figure>
                        <img src="img/client-12-hover.jpg" alt="Orel-Corporation" style="padding: 5rem;" />
                        </figure>
                        <div class="article-body">
                            <h5>Orel Corporation</h5>
                        </div>
                     </div>
                </article>
                </section>
            ...
            <div class="col-md-3">
                ...
                <article>
                    <div class="article-wrapper">
                        <figure>
                        <img src="img/client-13-hover.jpg" alt="National Transport Commission" style="width: 85px; height: auto; padding-top: 3rem"/>
                        </figure>
                        <div class="article-body">
            ...
            <div class="col-md-3">
                ...
                <article>
                    <div class="article-wrapper">
                        <figure>
                        <img src="img/client-14-hover.jpg" alt="Cinnamon-Life" style="width: 100px; height: auto; padding-top: 3rem"/>
                        </figure>
                        <div class="article-body">
                            <h5>Cinnamon Life</h5>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <h2>Foreign Clients and Partners</h2>
            </div>
        </div>
        <div class="col-md-3">
            <section class="articles">
                <article>
                    <div class="article-wrapper">
                        <figure>
                        <img src="img/client-f1-hover.jpg" alt="C2M-TechSolutions" style="width: 170px; height: auto; padding-top: 4rem"/>
                        </figure>
                        <div class="article-body">
                            <h5>C2M TechSolutions</h5>
                        </div>
                    </div>
                </article>
            </section>
        ...
        <div class="col-md-3">
            <section class="articles">
                <article>
                    <div class="article-wrapper">
                        <figure>
                        <img src="img/client-f2-hover.jpg" alt="Diamond-Dental-Center" style="width: 170px; height: auto; padding-top: 3rem"/>
                        </figure>
                        <div class="article-body">
                            <h5>Diamond Dental Center</h5>
                        </div>
                    </div>
                </article>
            </section>
        ...
        <div class="col-md-3">
            <section class="articles">
                <article>
                    <div class="article-wrapper">
                        <figure>
                        <img src="img/client-f3-hover.png" alt="Gaash-Lighting" style="width: 100px; height: auto; padding-top: 3rem"/>
                        </figure>
                        <div class="article-body">
                            <h5>Gaash Lighting</h5>
                        </div>
                    </div>
                </article>
            </section>
        ...
        <div class="col-md-3">
            <section class="articles">
                <article>
                    <div class="article-wrapper">
                        <figure>
                        <img src="img/client-f4-hover.jpg" alt="TradeNet" style="width: 90px; height: auto; padding-top: 3rem"/>
                        </figure>
                        <div class="article-body">
                            <h5>TradeNet</h5>
                        </div>
           ...
           <!--     <div class="col-md-2 col-sm-3 col-xs-6 client-1 revealOnScroll opacity-0" data-animation="fadeIn" data-timeout="300"></div>
               ...
               <!-- <div class="col-md-2 col-sm-3 col-xs-6 client-10 revealOnScroll opacity-0" data-animation="fadeIn" data-timeout="800"></div>
                <div class="col-md-2 col-sm-3 col-xs-6 client-11 revealOnScroll opacity-0" data-animation="fadeIn" data-timeout="800"></div>
                <div class="col-md-2 col-sm-3 col-xs-6 client-12 revealOnScroll opacity-0" data-animation="fadeIn" data-timeout="800"></div>
                <div class="col-md-2 col-sm-3 col-xs-6 client-13 revealOnScroll opacity-0" data-animation="fadeIn" data-timeout="800"></div>
                <div class="col-md-2 col-sm-3 col-xs-6 client-14 revealOnScroll opacity-0" data-animation="fadeIn" data-timeout="800"></div>-->
...
<div class="row">
    <!--
    <div class="col-md-2 col-sm-3 col-xs-6 revealOnScroll opacity-0" data-animation="fadeIn" data-timeout="300" >
        <div class="col-md-3">-->
            <!--<div class="profile-sidebar">-->
                <!-- SIDEBAR USERPIC -->
                <!--<div class="profile-userpic">
                                        <img src="img/client-f1-hover.jpg" class="img-responsive" alt="">
                </div>-->
                <!-- END SIDEBAR USERPIC -->
                <!-- SIDEBAR USER TITLE -->
                <!--<div class="profile-usertitle">
                        <div class="profile-usertitle-name">
                                                    <a href="https://www.c2mtechsolutions.com.au/" target="_BLANK">C2M TechSolutions </a>
                        </div>
    ...
    <!--
    <div class="col-md-2 col-sm-3 col-xs-6 revealOnScroll opacity-0" data-animation="fadeIn" data-timeout="400">
        <div class="profile-sidebar">
                <!-- SIDEBAR USERPIC -->
                <!--<div class="profile-userpic">
                                        <img src="img/client-f2-hover.jpg" class="img-responsive" alt="">
                </div>-->
                <!-- END SIDEBAR USERPIC -->
                <!-- SIDEBAR USER TITLE -->
                <!--<div class="profile-usertitle">
                        <div class="profile-usertitle-name">
                                                    <a href="https://diamonddentalcentre.com.au/" target="_BLANK">Diamond Dental Centre</a>
                        </div>
                        <div class="profile-usertitle-job">
                                Australia
                        </div>
    ...
    <!--
    <div class="col-md-2 col-sm-3 col-xs-6 revealOnScroll opacity-0" data-animation="fadeIn" data-timeout="500">
        <div class="profile-userpic">
            <img src="img/client-f3-hover.png" class="img-responsive" alt="GAASH" width="50%">
        </div>
                <!-- END SIDEBAR USERPIC -->
                <!-- SIDEBAR USER TITLE -->
        <!--<div class="profile-usertitle">
                        <div class="profile-usertitle-name">
                                                    <a href="https://gaash.com/" target="_BLANK" >Gaash Lightning</a>
                        </div>
                        <div class="profile-usertitle-job">
                                Israel
                        </div>
...
<!--</div>
    ...
    <div class="col-lg-offset-3 col-lg-6"> <!-- Adjusted offset and width -->
    ...
    <?php endif; ?>
                ...
                <div class="map-boarder col-md-6">
...
<!--                    <h4>Development Centre</h4>
                    ...
                    <p><b>Telephone :</b> +94 71 922 9233 </br>
                    <!--<b>Fax:</b> +94 11  2 986388</p>-->
                    <div class="row">
                <div class="col-md-12">
                  Copyright 2017, I3 CUBES (Pvt) Ltd
                  <br>
                </div>
            </div>
                </div>
...
<!--    <div class="social">
  ...
  ga('send', 'pageview');
    ...
    <script src="https://maps.googleapis.com/maps/api/js?callback=initMap&key=AIzaSyBG9B3zdoqLsxv2ZApP_gk2vPy5O6WBQW0" async defer></script>
</body>
</html>